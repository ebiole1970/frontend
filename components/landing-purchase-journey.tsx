...
export function LandingPurchaseJourney({
  ...
  return (
    <div className={`space-y-8 ${className}`} id="mini-guida-visiva">
      {!hideHeading ? (
        <div>
          <h3 className="text-lg font-semibold text-slate-100">Cosa vedi dopo l’acquisto — mini guida visiva</h3>
      ...
      <div className="grid gap-8 sm:grid-cols-2 xl:grid-cols-4">
        ...
        >
          <div className="rounded-lg border border-slate-700 bg-slate-950/80 p-3 font-mono text-[11px] text-slate-300">
            <p className="text-[10px] uppercase tracking-wide text-slate-500">Dominio target</p>
            ...
            <div className="mt-4 flex h-8 items-center justify-center rounded border border-dashed border-slate-600 text-[10px] text-slate-600">
        ...
        >
          <div className="space-y-2 rounded-lg border border-slate-700 bg-slate-950/80 p-3 text-[11px]">
            ...
            <p className="text-[10px] text-slate-500">Pre-scan: policy, consensi, IP richiedente</p>
          </div>
        </JourneyPanel>
        ...
        >
          <div className="space-y-2 rounded-lg border border-slate-700 bg-slate-950/80 p-3 text-[11px]">
            ...
            <p className="text-center text-[10px] text-slate-600">Pulsanti reali attivi dopo login</p>
          </div>
        </JourneyPanel>
      </div>
    </div>
  ...
  return (
    <div className="flex flex-col">
      <div className="flex items-center gap-1.5 rounded-t-lg border border-b-0 border-slate-700 bg-slate-800/90 px-2 py-1.5">
        ...
        <span className="ml-auto text-[9px] text-slate-500">anteprima</span>
      </div>
      <div className="flex-1 rounded-b-lg border border-slate-700 bg-slate-900/95 p-3">
        <p className="text-[10px] font-semibold text-emerald-400/90">Passo {step}</p>
