...
export default function SubscriptionPage() {
  ...
  const proPrice = tiers?.professional_monthly?.price_monthly_eur ?? 49.99;
      ...
      <section className="mt-10">
        ...
        <div className="mt-4 grid gap-4 md:grid-cols-2">
          <article className="rounded-xl border border-slate-800 bg-slate-900/50 p-5">
            ...
            <p className="mt-2 text-emerald-300">9,99 EUR</p>
          ...
          <article className="rounded-xl border border-slate-800 bg-slate-900/50 p-5">
            ...
            <p className="mt-2 text-emerald-300">19,99 EUR</p>
